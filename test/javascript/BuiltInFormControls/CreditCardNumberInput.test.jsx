...
describe('CreditCardNumberInput', () => {
  ...
  test('it renders a default credit card image when there is no value', () => {
    ...
    expect(component.find('.input-group-addon i').prop('className')).toEqual('fa fa-credit-card');
  });
  ...
  test('it renders a Visa credit card image when it is a Visa card', () => {
    ...
    expect(component.find('.input-group-addon i').prop('className')).toEqual('fa fa-cc-visa text-success');
  });
  ...
  test('it renders a MasterCard credit card image when it is a MasterCard card', () => {
    ...
    expect(component.find('.input-group-addon i').prop('className')).toEqual('fa fa-cc-mastercard text-success');
  });
  ...
  test('it renders an Amex credit card image when it is an Amex card', () => {
    ...
    expect(component.find('.input-group-addon i').prop('className')).toEqual('fa fa-cc-amex text-success');
  });
  ...
  test('it renders a Discover credit card image when it is a Discover card', () => {
    ...
    expect(component.find('.input-group-addon i').prop('className')).toEqual('fa fa-cc-discover text-success');
  });
  ...
  test('it renders a Diners Club credit card image when it is a Diners Club card', () => {
    ...
    expect(component.find('.input-group-addon i').prop('className')).toEqual('fa fa-cc-dinersclub text-success');
  });
  ...
  test('it renders a JCB credit card image when it is a JCB card', () => {
    ...
    expect(component.find('.input-group-addon i').prop('className')).toEqual('fa fa-cc-jcb text-success');
  });
  ...
  test('it renders a black icon when it is a partial card number', () => {
    ...
    expect(component.find('.input-group-addon i').prop('className')).toEqual('fa fa-cc-visa');
  });
  ...
  test('it renders an error icon when it is an invalid card number', () => {
    ...
    expect(component.find('.input-group-addon i').prop('className')).toEqual('fa fa-exclamation-triangle text-danger');
  });
});
