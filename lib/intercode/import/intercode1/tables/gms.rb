class Intercode::Import::Intercode1::Tables::GMs < Intercode::Import::Intercode1::Table
  BOOL_FIELD_MAP = { display: :DisplayAsGM, show_email: :DisplayEMail, receive_con_email: :ReceiveConEMail }
  ...
  def build_record(row)
    ...
    BOOL_FIELD_MAP.each { |team_member_field, row_field| team_member[team_member_field] ||= row[row_field] }
