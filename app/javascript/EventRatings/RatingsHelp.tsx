...
function RatingsHelp(): React.JSX.Element {
  return (
    <Trans i18nKey="events.ratings.helpText">
      ...
      an event from your default view by clicking the <EventRatingIcon rating={-1} /> icon. To revert to “TBD,” click
      the icon again. Your preferences are always private, and event runners and convention staff cannot see what you’ve
      favorited or hidden.
    </Trans>
  );
}
