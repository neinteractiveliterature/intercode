...
export type ConventionAdminConventionFieldsFragment = { __typename: 'Convention', id: string, accepting_proposals?: boolean | null | undefined, starts_at?: string | null | undefined, ends_at?: string | null | undefined, canceled: boolean, name: string, domain?: string | null | undefined, email_from: string, email_mode: Types.EmailMode, event_mailing_list_domain?: string | null | undefined, location?: string | null | undefined, language: string, timezone_name?: string | null | undefined, timezone_mode: Types.TimezoneMode, show_schedule?: Types.ShowSchedule | null | undefined, show_event_list?: Types.ShowSchedule | null | undefined, hidden: boolean, maximum_tickets?: number | null | undefined, ticket_name: string, ticketNamePlural: string, clickwrap_agreement?: string | null | undefined, ticket_mode: Types.TicketMode, site_mode: Types.SiteMode, signup_mode: Types.SignupMode, signup_requests_open: boolean, stripe_account_ready_to_charge: boolean, favicon?: { __typename: 'ActiveStorageAttachment', id: string, url: string } | null | undefined, open_graph_image?: { __typename: 'ActiveStorageAttachment', id: string, url: string } | null | undefined, stripe_account?: { __typename: 'StripeAccount', id: string, email?: string | null | undefined, charges_enabled: boolean, display_name?: string | null | undefined } | null | undefined, maximum_event_signups?: { __typename: 'ScheduledValue', timespans: Array<{ __typename: 'TimespanWithValue', start?: string | null | undefined, finish?: string | null | undefined, value: string }> } | null | undefined, defaultLayout: { __typename: 'CmsLayout', id: string, name?: string | null | undefined }, cmsLayouts: Array<{ __typename: 'CmsLayout', id: string, name?: string | null | undefined }>, rootPage: { __typename: 'Page', id: string, name?: string | null | undefined }, cmsPages: Array<{ __typename: 'Page', id: string, name?: string | null | undefined }>, staff_positions: Array<{ __typename: 'StaffPosition', id: string, name: string }>, catch_all_staff_position?: { __typename: 'StaffPosition', id: string, name: string } | null | undefined };

export type ConventionAdminConventionQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type ConventionAdminConventionQueryData = { __typename: 'Query', convention: { __typename: 'Convention', id: string, accepting_proposals?: boolean | null | undefined, starts_at?: string | null | undefined, ends_at?: string | null | undefined, canceled: boolean, name: string, domain?: string | null | undefined, email_from: string, email_mode: Types.EmailMode, event_mailing_list_domain?: string | null | undefined, location?: string | null | undefined, language: string, timezone_name?: string | null | undefined, timezone_mode: Types.TimezoneMode, show_schedule?: Types.ShowSchedule | null | undefined, show_event_list?: Types.ShowSchedule | null | undefined, hidden: boolean, maximum_tickets?: number | null | undefined, ticket_name: string, ticketNamePlural: string, clickwrap_agreement?: string | null | undefined, ticket_mode: Types.TicketMode, site_mode: Types.SiteMode, signup_mode: Types.SignupMode, signup_requests_open: boolean, stripe_account_ready_to_charge: boolean, favicon?: { __typename: 'ActiveStorageAttachment', id: string, url: string } | null | undefined, open_graph_image?: { __typename: 'ActiveStorageAttachment', id: string, url: string } | null | undefined, stripe_account?: { __typename: 'StripeAccount', id: string, email?: string | null | undefined, charges_enabled: boolean, display_name?: string | null | undefined } | null | undefined, maximum_event_signups?: { __typename: 'ScheduledValue', timespans: Array<{ __typename: 'TimespanWithValue', start?: string | null | undefined, finish?: string | null | undefined, value: string }> } | null | undefined, defaultLayout: { __typename: 'CmsLayout', id: string, name?: string | null | undefined }, cmsLayouts: Array<{ __typename: 'CmsLayout', id: string, name?: string | null | undefined }>, rootPage: { __typename: 'Page', id: string, name?: string | null | undefined }, cmsPages: Array<{ __typename: 'Page', id: string, name?: string | null | undefined }>, staff_positions: Array<{ __typename: 'StaffPosition', id: string, name: string }>, catch_all_staff_position?: { __typename: 'StaffPosition', id: string, name: string } | null | undefined }, rootSite: { __typename: 'RootSite', id: string, url: string } };
