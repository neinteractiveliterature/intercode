...
export type AttendanceByPaymentAmountQueryData = { __typename: 'Query', convention: { __typename: 'Convention', id: number, ticket_name: string, reports: { __typename: 'ConventionReports', ticket_count_by_type_and_payment_amount: Array<{ __typename: 'TicketCountByTypeAndPaymentAmount', count: number, ticket_type: { __typename: 'TicketType', id: number, name: string, description?: string | null | undefined, providing_products: Array<{ __typename: 'Product', id: number, pricing_structure: { __typename: 'PricingStructure', pricing_strategy: Types.PricingStrategy, price?: { __typename: 'Money', fractional: number, currency_code: string } | null | undefined, value: { __typename: 'Money', fractional: number, currency_code: string } | { __typename: 'ScheduledMoneyValue', timespans: Array<{ __typename: 'TimespanWithMoneyValue', start?: any | null | undefined, finish?: any | null | undefined, value: { __typename: 'Money', fractional: number, currency_code: string } }> } } }> }, payment_amount: { __typename: 'Money', fractional: number, currency_code: string } }>, total_revenue: { __typename: 'Money', fractional: number, currency_code: string } } } };

export type EventProvidedTicketsQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type EventProvidedTicketsQueryData = { __typename: 'Query', convention: { __typename: 'Convention', id: number, ticket_name: string, reports: { __typename: 'ConventionReports', event_provided_tickets: Array<{ __typename: 'EventProvidedTicketList', provided_by_event: { __typename: 'Event', id: number, title?: string | null | undefined }, tickets: Array<{ __typename: 'Ticket', id: number, user_con_profile: { __typename: 'UserConProfile', id: number, name_inverted: string }, ticket_type: { __typename: 'TicketType', id: number, description?: string | null | undefined } }> }> } } };

export type EventsByChoiceQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type EventsByChoiceQueryData = { __typename: 'Query', convention: { __typename: 'Convention', id: number, reports: { __typename: 'ConventionReports', events_by_choice: Array<{ __typename: 'EventWithChoiceCounts', event: { __typename: 'Event', id: number, title?: string | null | undefined }, choice_counts: Array<{ __typename: 'ChoiceCount', state: Types.SignupState, choice: number, count: number }> }> } } };
