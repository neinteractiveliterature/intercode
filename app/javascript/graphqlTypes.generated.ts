...
/** Autogenerated input type of CreateOrUpdateRunForEvent */
export type CreateOrUpdateRunForEventInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the event the run is for. */
  eventId?: InputMaybe<Scalars['ID']['input']>;
  /** The run attributes to create or update. */
  run: RunInput;
};

/** Autogenerated return type of CreateOrUpdateRunForEvent. */
export type CreateOrUpdateRunForEventPayload = {
...
export type DeleteOAuthApplicationPayload = {
  ...
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The deleted OAuth2 application. */
  oauth_application: OAuthApplication;
};
...
export type EventInput = {
  ...
  bucket_key_mappings?: InputMaybe<Array<BucketKeyMappingInput>>;
...
export type Mutation = {
   ...
   * created.
   */
  createOrUpdateRunForEvent: CreateOrUpdateRunForEventPayload;
  ...
  deleteOAuthApplication: DeleteOAuthApplicationPayload;
  ...
  /** Regenerates the secret for an OAuth2 application. Returns the new plaintext secret once. */
  regenerateOAuthApplicationSecret: RegenerateOAuthApplicationSecretPayload;
  ...
  updateOAuthApplication: UpdateOAuthApplicationPayload;
...
export type MutationCreateOrUpdateRunForEventArgs = {
  input: CreateOrUpdateRunForEventInput;
};
...
export type MutationRegenerateOAuthApplicationSecretArgs = {
  input: RegenerateOAuthApplicationSecretInput;
};
...
export type Query = {
  ...
  /** Returns all OAuth2 applications registered in this Intercode instance (site admin only). */
...
export enum RankedChoiceDecisionReason {
  ...
  WaitlistPositionCapExceeded = 'WAITLIST_POSITION_CAP_EXCEEDED'
}
...
/** Autogenerated return type of RegenerateOAuthApplicationSecret. */
export type RegenerateOAuthApplicationSecretPayload = {
  __typename: 'RegenerateOAuthApplicationSecretPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The OAuth2 application with a newly generated secret. */
  oauth_application: OAuthApplication;
  /** The new plaintext client secret. Store it now; it will not be shown again. */
  secret: Scalars['String']['output'];
};
...
export type SetSignupRankedChoicePrioritizeWaitlistInput = {
  ...
  /**
   * Only prioritize waitlisting if the resulting position would be at or below
   * this number. Null means no cap.  Only relevant when prioritize_waitlist is true.
   */
  waitlistPositionCap?: InputMaybe<Scalars['Int']['input']>;
};
...
export type SignupRankedChoice = {
   ...
   */
  waitlist_position_cap?: Maybe<Scalars['Int']['output']>;
};
...
export type UpdateOAuthApplicationPayload = {
  ...
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The updated OAuth2 application. */
  oauth_application: OAuthApplication;
};
