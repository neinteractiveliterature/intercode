                ...
                children: [
                  {
                    element: (
                      <AppRootContextRouteGuard
                        guard={({ conventionName, siteMode }) =>
                          conventionName != null && siteMode !== SiteMode.SingleEvent
                        }
                      />
                    ),
                    children: [
                        ...
                        children: [
                          {
                            ...
                            children: [
                              {
                                path: 'new',
                                id: NamedRoute.NewEventCategory,
                                lazy: () => import('./EventCategoryAdmin/NewEventCategory'),
                              },
                              {
                                path: ':id',
                      ...
                      },
                      {
                        ...
                        children: [
                          ...
                          {
                            index: true,
                            loader: () => replace('/pages/new-proposal'),
                            lazy: () => import('./EventProposals/route'),
                          },
                        ],
                      },
                    ],
                    ...
                    children: [
                      ...
                      },
                      {
                        ...
                        children: [
                          {
                            element: (
                              <AppRootContextRouteGuard guard={({ siteMode }) => siteMode !== SiteMode.SingleEvent} />
                            ),
                            children: [
                              { path: 'dropped_events', lazy: () => import('./EventAdmin/DroppedEventAdmin') },
                              {
                                ...
                                children: [
                                  { path: 'events/new', lazy: () => import('./EventAdmin/NewEvent') },
                                  {
                                    ...
                                    lazy: () => import('./EventAdmin/EventAdminEditEvent'),
                                  },
                                  {
                                    path: '',
                                        ...
                                        children: [
                                          { index: true, loader: () => redirect('..') },
                                          {
                                            ...
                                            children: [
                                              {
                                                path: 'admin_notes',
                                                lazy: () => import('./EventAdmin/AdminNotesRoute'),
                                              },
                                                ...
                                                children: [
                                                  {
                                                    ...
                                                    children: [
                                                      { path: 'edit', lazy: () => import('./EventAdmin/EditRun') },
                                                    ],
                                                  },
                                                  {
                                                    path: 'create_multiple',
                                                    lazy: () => import('./EventAdmin/CreateMultipleRunsRoute'),
                                                  },
                        ...
                        children: [
                          {
                            ...
                            id: NamedRoute.FormJSONEditor,
                            lazy: () => import('./FormAdmin/FormJSONEditor'),
                          },
                          { path: ':id', lazy: () => import('./FormAdmin/$id/route') },
                          {
                            index: true,
                            id: NamedRoute.FormAdminIndex,
                            lazy: () => import('./FormAdmin/FormAdminIndex'),
                          },
                        ],
                      },
                      {
                                ...
                                children: [
                                  ...
                                  { path: 'mark_paid', lazy: () => import('./Store/OrderAdmin/mark_paid') },
                                  {
                                    ...
                                    children: [
                                      {
                                        path: ':orderEntryId',
                                        lazy: () => import('./Store/OrderAdmin/order_entries/$orderEntryId'),
                                      },
                                    ],
                                  },
                                  {
                                    ...
                                    children: [
                                      {
                                        ...
                                        lazy: () =>
                                          import('./Store/OrderAdmin/coupon_applications/$couponApplicationId'),
                                      },
                                    ],
                                  },
                                ],
                          ...
                          },
                          {
                            ...
                            children: [
                              { path: 'attach_image', lazy: () => import('./EventsApp/attach_image') },
                              {
                                element: (
                                  <AppRootContextRouteGuard
                                    guard={({ ticketMode }) => ticketMode === TicketMode.TicketPerEvent}
                                  />
                                ),
                                children: [
                                  {
                                    ...
                                    children: [
                                      {
                                        path: 'new',
                                        loader: eventTicketTypesLoader,
                                        lazy: () => import('./TicketTypeAdmin/NewTicketType'),
                                      },
                                      {
                                        path: ':id/edit',
                                      ...
                                      },
                                      {
                                        index: true,
                                        loader: eventTicketTypesLoader,
                                        lazy: () => import('./TicketTypeAdmin/TicketTypesList'),
                                      },
                                    ],
                                  },
                                ],
                              ...
                              },
                              {
                                ...
                                children: [
                                  {
                                    path: ':id',
                                    lazy: () => import('./EventsApp/MaximumEventProvidedTicketsOverrides/$id'),
                                  },
                                ],
                              },
                              {
                              ...
                              },
                              {
                                ...
                                children: [
                                  { path: ':changeGroupId', lazy: () => import('./EventsApp/EventPage/EventHistory') },
                                ],
                              },
                              {
                                path: 'runs/:runId',
                                    ...
                                    children: [
                                      {
                                        ...
                                        children: [
                                          {
                                            path: 'change_bucket',
                                            lazy: () => import('./EventsApp/SignupAdmin/$id/change_bucket'),
                                          },
                                          {
                                            path: 'force_confirm',
                                            lazy: () => import('./EventsApp/SignupAdmin/$id/force_confirm'),
                                          },
                                        ],
                                      },
                                      {
                              ...
                              },
                              {
                                ...
                                children: [
                                  {
                                    index: true,
                                    id: NamedRoute.EventPage,
                                    lazy: () => import('./EventsApp/EventPage'),
                                  },
                                ],
                              },
                            ],
                      ...
                      { path: '/products/:id', lazy: () => import('./Store/ProductPage') },
                      {
                        ...
                        children: [
                          {
                            path: 'attendance_by_payment_amount',
                            lazy: () => import('./Reports/AttendanceByPaymentAmount'),
                          },
                      ...
                      {
                        element: (
                          <AppRootContextRouteGuard guard={({ signupMode }) => signupMode === SignupMode.Moderated} />
                        ),
                        children: [
                          {
                                ...
                                children: [
                                  {
                                    ...
                                    children: [
                                      {
                                        path: ':userConProfileId',
                                        lazy: () => import('./SignupModeration/UserRankedChoiceQueue'),
                                      },
                                    ],
                                  },
                                ],
                                ...
                                children: [
                                  {
                                    ...
                                    children: [
                                      {
                                        path: 'accept',
                                        lazy: () => import('./SignupModeration/signup_requests/$id/accept'),
                                      },
                                      {
                                        path: 'reject',
                                        lazy: () => import('./SignupModeration/signup_requests/$id/reject'),
                                      },
                                    ],
                                  },
                                ],
                                ...
                                children: [
                                  {
                                    ...
                                    children: [
                                      {
                                        path: 'rerun',
                                        lazy: () => import('./SignupModeration/signup_rounds/$id/rerun'),
                                      },
                                    ],
                                  },
                                ],
                        ...
                        children: [
                          {
                            ...
                            children: [
                              {
                                path: 'results',
                                lazy: () => import('./SignupRoundsAdmin/RankedChoiceSignupDecisionsPage'),
                              },
                            ],
                          },
                      ...
                      },
                      {
                        element: (
                          <AppRootContextRouteGuard
                            guard={({ ticketMode }) => ticketMode === TicketMode.RequiredForSignup}
                          />
                        ),
                        children: [
                          {
                        ...
                        children: [
                          {
                            ...
                            children: [
                              {
                                path: ':id',
                                id: NamedRoute.UserAdminDisplay,
                                lazy: () => import('./Users/UserAdminDisplay'),
                              },
                              {
                  ...
                  },
                  {
                    ...
                    children: [
                        ...
                        children: [
                          {
                            ...
                            children: [
                              ...
                              {
                                path: 'view_source',
                                lazy: () => import('./CmsAdmin/CmsPartialsAdmin/ViewCmsPartialSource'),
                              },
                            ],
                          },
                        ...
                        children: [
                          {
                            ...
                            children: [
                              ...
                              {
                                path: 'view_source',
                                lazy: () => import('./CmsAdmin/CmsLayoutsAdmin/ViewCmsLayoutSource'),
                              },
                            ],
                          },
                      ...
                      },
                      {
                        ...
                        children: [
                          { path: ':key', lazy: () => import('./CmsAdmin/CmsVariablesAdmin/SingleVariableRoute') },
                        ],
                      },
                      {
                        ...
                        children: [
                          {
                            ...
                            children: [
                              {
                                path: 'edit',
                                lazy: () => import('./CmsAdmin/CmsGraphqlQueriesAdmin/EditCmsGraphqlQuery'),
                              },
                              {
                                path: 'view_source',
                          ...
                          {
                            index: true,
                            lazy: () => import('./CmsAdmin/CmsGraphqlQueriesAdmin/CmsGraphqlQueriesAdminTable'),
                          },
                        ],
                      },
                      {
                        ...
                        children: [
                          {
                            ...
                            children: [
                              {
                                path: 'edit',
                                lazy: () => import('./CmsAdmin/CmsContentGroupsAdmin/EditCmsContentGroup'),
                              },
                              {
                                index: true,
                          ...
                          {
                            index: true,
                            lazy: () => import('./CmsAdmin/CmsContentGroupsAdmin/CmsContentGroupsAdminTable'),
                          },
                        ],
                      },
                      {
