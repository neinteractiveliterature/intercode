...
export type SignInConventionQueryVariables = Exact<{ [key: string]: never; }>;


export type SignInConventionQueryData = { __typename: 'Query', signInConvention: { __typename: 'Convention', id: string, name: string } | null };
...
export const SignInConventionQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SignInConventionQuery"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"signInConvention"},"name":{"kind":"Name","value":"conventionByOauthReturnIfPresent"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<SignInConventionQueryData, SignInConventionQueryVariables>;
