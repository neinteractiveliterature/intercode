...
export type SignInContextQueryData = { __typename: 'Query', signInConvention: { __typename: 'Convention', id: string, name: string } | null, signInOAuthApplication: { __typename: 'AuthorizedApplication', uid: string, name: string, is_intercode_frontend: boolean } | null, rootSite: { __typename: 'RootSite', id: string, site_name: string } };
