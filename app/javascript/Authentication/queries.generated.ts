...
export type SignInContextQueryData = { __typename: 'Query', signInConvention: { __typename: 'Convention', id: string, name: string } | null, signInOAuthApplication: { __typename: 'AuthorizedApplication', uid: string, name: string } | null };
