...
export type PopperDropdownChildrenRenderFunction = (
  props: PopperDropdownChildrenProps,
) => JSX.Element;
...
const PopperDropdown: ForwardRefRenderFunction<
  ...
  PopperDropdownProps
> = ({ children, onToggle, placement, renderReference, style, visible, modifiers }, ref) => {
...
const PopperDropdownWithRefForwarding = forwardRef<
  PopperDropdownImperativeHandle,
  PopperDropdownProps
>(PopperDropdown);
