...
export type TeamMemberTicketFieldsFragment = { __typename: 'Ticket', id: number, user_con_profile: { __typename: 'UserConProfile', id: number }, ticket_type: { __typename: 'TicketType', id: number, name: string }, provided_by_event?: { __typename: 'Event', id: number, title?: string | null | undefined } | null | undefined };
...
export type TeamMembersQueryData = { __typename: 'Query', convention: { __typename: 'Convention', id: number, ticket_name: string, name: string, starts_at?: any | null | undefined, ends_at?: any | null | undefined, site_mode: Types.SiteMode, timezone_name?: string | null | undefined, timezone_mode: Types.TimezoneMode, ticket_mode: Types.TicketMode, event: { __typename: 'Event', id: number, title?: string | null | undefined, event_category: { __typename: 'EventCategory', id: number, can_provide_tickets: boolean, team_member_name: string }, provided_tickets: Array<{ __typename: 'Ticket', id: number, user_con_profile: { __typename: 'UserConProfile', id: number }, ticket_type: { __typename: 'TicketType', id: number, name: string }, provided_by_event?: { __typename: 'Event', id: number, title?: string | null | undefined } | null | undefined }>, team_members: Array<{ __typename: 'TeamMember', id: number, display_team_member: boolean, show_email: boolean, receive_con_email: boolean, receive_signup_email: Types.ReceiveSignupEmail, user_con_profile: { __typename: 'UserConProfile', id: number, name_without_nickname: string, name_inverted: string, email?: string | null | undefined, mobile_phone?: string | null | undefined, ticket?: { __typename: 'Ticket', id: number, user_con_profile: { __typename: 'UserConProfile', id: number }, ticket_type: { __typename: 'TicketType', id: number, name: string }, provided_by_event?: { __typename: 'Event', id: number, title?: string | null | undefined } | null | undefined } | null | undefined } }> }, ticket_types: Array<{ __typename: 'TicketType', id: number, name: string, description?: string | null | undefined, maximum_event_provided_tickets: number }>, event_categories: Array<{ __typename: 'EventCategory', id: number, name: string, scheduling_ui: Types.SchedulingUi, default_color?: string | null | undefined, full_color?: string | null | undefined, signed_up_color?: string | null | undefined }> } };
