...
export type EventFiltersInput = {
  category?: Array<number | null | undefined> | null | undefined;
  form_items?: unknown;
  my_rating?: Array<number> | null | undefined;
  text_search?: string | null | undefined;
...
export type ScheduleGridConventionDataQueryVariables = Exact<{ [key: string]: never; }>;


export type ScheduleGridConventionDataQueryData = { __typename: 'Query', currentAbility: { __typename: 'Ability', can_create_cms_partials: boolean }, convention: { __typename: 'Convention', id: string, name: string, starts_at: string | null, ends_at: string | null, signup_mode: Types.SignupMode, signup_automation_mode: Types.SignupAutomationMode, site_mode: Types.SiteMode, timezone_name: string | null, timezone_mode: Types.TimezoneMode, ticket_name: string, ticket_mode: Types.TicketMode, blockPartial: { __typename: 'CmsPartial', id: string, content: string | null, content_html: string, current_ability_can_update: boolean, current_ability_can_delete: boolean } | null, event_categories: Array<{ __typename: 'EventCategory', id: string, name: string, scheduling_ui: Types.SchedulingUi, default_color: string | null, full_color: string | null, signed_up_color: string | null, team_member_name: string, teamMemberNamePlural: string, event_form: { __typename: 'Form', id: string, form_sections: Array<{ __typename: 'FormSection', id: string, form_items: Array<{ __typename: 'FormItem', id: string, public_description: string | null, default_value: string | null, position: number, identifier: string | null, item_type: string, rendered_properties: string, visibility: Types.FormItemRole, writeability: Types.FormItemRole, expose_in: Array<Types.FormItemExposeIn> | null }> }> } }> } };

export type ScheduleGridEventsQueryVariables = Exact<{
  start?: string | null | undefined;
  finish?: string | null | undefined;
  filters?: Types.EventFiltersInput | null | undefined;
  fetchFormItemIdentifiers?: Array<string> | string | null | undefined;
}>;
