...
export type MySignupRankedChoiceFieldsFragment = { __typename: 'SignupRankedChoice', id: string, state: Types.SignupRankedChoiceState, requested_bucket_key?: string | null, target_run: { __typename: 'Run', id: string } };
