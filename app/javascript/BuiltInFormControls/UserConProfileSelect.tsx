...
type DO<QueryType extends DefaultUserConProfilesQueryQuery> = (
  NonNullable<QueryType['convention']>['user_con_profiles_paginated']['entries'][0]
);

export type UserConProfileSelectProps<DataType, OptionType extends OptionTypeBase> = (
...
function UserConProfileSelect<DataType extends DQ = DQ, OptionType extends DO<DataType> = DO<DQ>>(
  { userConProfilesQuery, ...otherProps }: UserConProfileSelectProps<DataType, OptionType>,
) {
  return (
