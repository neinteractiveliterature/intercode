...
export type TicketTypeInput = {
  allows_event_signups?: boolean | null | undefined;
  counts_towards_convention_maximum?: boolean | null | undefined;
  description?: string | null | undefined;
  maximum_event_provided_tickets?: number | null | undefined;
  name?: string | null | undefined;
  pricing_schedule?: ScheduledMoneyValueInput | null | undefined;
  publicly_available?: boolean | null | undefined;
};
...
export type CreateTicketTypeMutationData = { __typename: 'Mutation', createTicketType: { __typename: 'CreateTicketTypePayload', ticket_type: { __typename: 'TicketType', id: string, name: string, description: string | null, counts_towards_convention_maximum: boolean, allows_event_signups: boolean, maximum_event_provided_tickets: number, providing_products: Array<{ __typename: 'Product', id: string, name: string, available: boolean, pricing_structure: { __typename: 'PricingStructure', pricing_strategy: Types.PricingStrategy, price: { __typename: 'Money', fractional: number, currency_code: string } | null, value:
...
export type UpdateTicketTypeMutationData = { __typename: 'Mutation', updateTicketType: { __typename: 'UpdateTicketTypePayload', ticket_type: { __typename: 'TicketType', id: string, name: string, description: string | null, counts_towards_convention_maximum: boolean, allows_event_signups: boolean, maximum_event_provided_tickets: number, providing_products: Array<{ __typename: 'Product', id: string, name: string, available: boolean, pricing_structure: { __typename: 'PricingStructure', pricing_strategy: Types.PricingStrategy, price: { __typename: 'Money', fractional: number, currency_code: string } | null, value:
            | { __typename: 'Money', fractional: number, currency_code: string }
            | { __typename: 'PayWhatYouWantValue', allowed_currency_codes: Array<string> | null, maximum_amount: { __typename: 'Money', currency_code: string, fractional: number } | null, minimum_amount: { __typename: 'Money', currency_code: string, fractional: number } | null, suggested_amount: { __typename: 'Money', currency_code: string, fractional: number } | null }
            | { __typename: 'ScheduledMoneyValue', timespans: Array<{ __typename: 'TimespanWithMoneyValue', start: string | null, finish: string | null, value: { __typename: 'Money', fractional: number, currency_code: string } }> }
           } }> } } };
