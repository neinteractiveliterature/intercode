class CloneConventionService < CivilService::Service
  ...
  def clone_store_content(convention)
    ...
    @id_maps[:products] = clone_with_id_map(
      ...
      cloned_product.pricing_structure = shift_pricing_structure_by_convention_distance(
        convention,
  ...
  def shift_pricing_structure_by_convention_distance(convention, value)
    ...
    PricingStructure.new(value.attributes.merge(
      value: shift_scheduled_value_by_convention_distance(convention, value.value)
    ))
  end
