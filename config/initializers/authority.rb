Authority.configure do |config|
  ...
  #
  # In order to allow this to work for logged-out users, we use a method that
  # will either return the current user, or an unprivileged, anonymous one.
  config.user_method = :current_or_anonymous_user
