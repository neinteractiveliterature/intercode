...
9e414a5611497bc8f"
  ...
  # Use GET for sign-out so the OIDC end_session_endpoint (a browser redirect) works.
  # The Devise session is only used for the OAuth authorization flow; the app uses
  # JWT bearer tokens for actual auth, so CSRF-triggered logout has no meaningful impact.
