...
// EventsApp/SignupAdmin/$id/force_confirm.tsx
...
import type { Info as Parent7 } from "../../+types/RunHeader"
import type { Info as Parent8 } from "../../+types/route"
import type { Info as Parent9 } from "./route"

type Module = typeof import("../force_confirm")

export type Info = {
  parents: [Parent0, Parent1, Parent2, Parent3, Parent4, Parent5, Parent6, Parent7, Parent8, Parent9],
  id: "EventsApp/SignupAdmin/$id/force_confirm"
  file: "EventsApp/SignupAdmin/$id/force_confirm.tsx"
  path: "force_confirm"
