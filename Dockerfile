...
RUN apt-get update && apt-get install -y --no-install-recommends openssh-client bash curl python libvips42 poppler-utils curl xz-utils libjemalloc2 shared-mime-info libpq5 && rm -rf /var/lib/apt/lists/*
RUN mkdir /opt/node && \
