...
ActiveRecord::Schema.define(version: 2019_09_21_202956) do
  ...
  create_table "conventions", id: :serial, force: :cascade do |t|
    ...
    t.string "signup_mode", default: "self_service", null: false
    t.boolean "signup_requests_open", default: false, null: false
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.text "legacy_password_sha1"
    t.text "legacy_password_sha1_salt"
